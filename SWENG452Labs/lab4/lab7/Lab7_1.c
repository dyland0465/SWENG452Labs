// Fork of Lab7.c for activity 1. Will compile as Lab7_1 while the main file
// will be compiled as Lab7
...
void *T1(double *currentTemp, int *exitLoop, char *tempVal, char *regVal) {
  ...
  *regVal = buffer;
  ...
  address.sin_addr.s_addr =
      inet_addr("192.168.1.35"); // Likely the IP of the raspberry pi
